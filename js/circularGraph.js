...
document.addEventListener('DOMContentLoaded', function() {
    console.log('Inicializando grafo circular (versión restaurada)...');
    ...
    // Función para cargar SVG (placeholder)
    async function cargarSVG(ingrediente) {
        console.log(`Carga de SVG para ${ingrediente} no implementada`);
        return null; // Retornar null para que use el método matemático
    }
    ...
    d3.text('./json/platillos_expandido.csv')
        ...
        .catch(function(error) {
            ...
            nodes = [
                {id: 'Prehispánica', name: 'Prehispánica', level: 1, connections: 5},
            ...
            d3.select('#network')
                ...
                .text('Usando datos de demostración. El archivo CSV no pudo cargarse.');
